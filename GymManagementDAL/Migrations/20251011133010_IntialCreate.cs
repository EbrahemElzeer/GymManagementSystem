        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneValidFormatConstraint", "Phone LIKE '01[0,1,2,5]%' AND LEN(Phone) = 11 AND Phone NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneValidFormatConstraint1", "Phone LIKE '01[0,1,2,5]%' AND LEN(Phone) = 11 AND Phone NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CapacityConstrin", "Capacity between 1 and 25");
                    table.CheckConstraint("StartEndTimeConstraint", "EndTime > StartTime");
                    table.ForeignKey(
